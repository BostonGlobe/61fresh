...
cd $CONDOR_HOME/www
s3cmd --add-header "Cache-Control: max-age=60" --recursive put --acl-public --guess-mime-type controllers css feed.html index.html about.html homepage.html js piggyback templates images $bucket_name
